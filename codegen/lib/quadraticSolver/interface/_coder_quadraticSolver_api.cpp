...
// File: _coder_quadraticSolver_api.cpp
//
...
void quadraticSolver_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  ...
  roots = (real_T(*)[2])mxMalloc(sizeof(real_T[2]));
  ...
  quadraticSolver(a, b, c, *roots);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*roots);
}
...
void quadraticSolver_atexit()
{
  ...
  quadraticSolver_xil_terminate();
  quadraticSolver_xil_shutdown();
...
//
// File trailer for _coder_quadraticSolver_api.cpp
//
// [EOF]
//
